    ...
    >
      <Box m={3}>
        <Card className={cx(cardStyles.root, shadowStyles.root)}>
          <BrandCardHeader
            image={
              "http://math-universe.com.tn/assets/img/11.png"
            }
            extra={"3 minutes"}
          />
          <CardContent className={cardStyles.content}>
            <TextInfoContent
              classes={styles}
              overline={"MathUniverse"}
              heading={"About"}
              body={
                "This is an E-learning Web App was bootstrapped with Create React App and other libraries. The UI was built based on Material-UI also with it's associated libraries ecosystem"
              }
            />
            <TextInfoContent
              classes={styles}
